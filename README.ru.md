...
![Пример поиска через модальное окно: ввод «детей на площадку» находит «Ребёнок на площадке» благодаря словарю супплетивных форм, а рекомендуемая горячая клавиша подсвечена](docs/demo/ru/modal-search.png)
...
- **Поддержка алиасов**: Поиск работает по заголовкам заметок, алиасам из frontmatter и отображаемым текстам из вики-ссылок. Если в хранилище есть ссылка вида `[[Заметка|свой текст]]`, то «свой текст» автоматически используется как алиас целевой заметки.
- **Независимость от порядка слов**: «коробку деревянную» найдёт «Деревянная коробка».
- **Мультиязычность**: Русский и английский поиск работают одновременно. Морфологический анализ русского языка основан на данных словаря [OpenCorpora](https://opencorpora.org/), английского — на списках исключений [WordNet](https://wordnet.princeton.edu/).
...
**Поиск по супплетивным формам**
Вводим совершенно другую форму слова — «детей на площадку» находит заметку «Ребёнок на площадке» благодаря словарю супплетивных форм (`дети` → `ребёнок`).
![Демо поиска по супплетивным формам](docs/demo/ru/suppletive-search.gif)
...
Морфологические словари генерируются из открытых данных на этапе сборки:

- **Русский**: [OpenCorpora](https://opencorpora.org/) (лицензия: [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/))
- **Английский**: [WordNet](https://wordnet.princeton.edu/)
